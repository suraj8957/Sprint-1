...
5. [GitOps Workflow Types](#5-gitops-workflow-types)
   - 5.1 [Push-Based Workflow (Traditional CI/CD)](#51-push-based-workflow-traditional-ci-cd)
   - 5.2 [Pull-Based GitOps Workflow (Recommended)](#52-pull-based-gitops-workflow-recommended)
